    ...
    >
      <div className="w-full max-w-md p-8 shadow-xl bg-white/80 backdrop-blur-sm rounded-2xl">
        ...
        <div className="space-y-6">
          ...
          {/* Submit Button */}
          <button className="w-full py-4 font-semibold text-white transition-colors duration-200 transform bg-red-800 rounded-lg hover:bg-red-900 disabled:bg-gray-400 disabled:cursor-not-allowed hover:scale-105 disabled:hover:scale-100">
