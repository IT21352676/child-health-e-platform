  ...
  return (
    <div className="flex flex-col items-center text-center min-h-screen bg-gradient-to-b from-white to-[#fdf7f7] px-4 py-5">
      ...
      <div className="mt-3 space-y-1">
        ...
        <h2 className="text-sm sm:text-base">குழந்தை சுகாதார மேம்பாட்டு பதிவு</h2>
      ...
      <div className="flex flex-col justify-center w-full gap-3 mt-5 sm:flex-row sm:w-auto">
        ...
        <Link
        to={`/loadingscreen`}><button className="bg-[#7b0000] text-white rounded-lg px-3 py-2 w-full sm:w-[110px] md:w-[130px] h-[55px] text-sm sm:text-sm md:text-base leading-tight">
          WELCOME <br />
          <span className="text-[8px] sm:text-xs font-normal">
            VIEW IN ENGLISH
          </span>
