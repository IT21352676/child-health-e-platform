  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-pink-50">
      ...
      <main className="max-w-6xl p-4 pt-24 mx-auto md:p-6 lg:p-8">
        <h1 className="mb-8 text-2xl font-bold text-red-800 md:text-3xl lg:text-4xl">
          Parent Profile
        </h1>
            ...
            <div className="flex-1 space-y-4 lg:space-y-6">
              ...
              <div className="space-y-4 md:hidden">
                ...
                <div className="space-y-2">
                  ...
                  <p className="font-medium text-red-800 break-all">
                    hasini458@gmail.com
                  </p>
                </div>
              ...
              <div className="hidden space-y-4 md:block lg:space-y-6">
                <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-6">
                  <div className="flex">
                    <span className="flex-shrink-0 font-semibold text-gray-700 w-36 lg:w-40">
                      Full Name
                    </span>
                  ...
                  <div className="flex">
                    ...
                    <span className="flex-shrink-0 mr-4 text-gray-600">:</span>
                    <span className="font-medium text-red-800 break-all lg:break-normal">
                      hasini458@gmail.com
                    </span>
                  </div>
              ...
              <div className="flex flex-col lg:flex-row">
                ...
                <div className="flex-1 p-4 md:p-6 lg:p-8">
                  <div className="mb-4 lg:mb-6">
                    <h3 className="mb-2 text-base font-bold text-red-800 lg:text-lg">
                      Child {String(index + 1).padStart(2, "0")}
                    </h3>
                    <h2 className="mb-4 text-lg font-bold text-red-800 md:text-xl lg:text-2xl">
                      {child.name}
                    </h2>
                  </div>
                  ...
                  <div className="mb-6 space-y-3 md:hidden">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-2">
                        <div
                          className={`w-2 h-2 rounded-full ${child.statusDot}`}
                        ></div>
                        <span className={`font-medium ${child.statusColor}`}>
                          {child.status}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="hidden mb-6 space-y-3 md:block lg:space-y-4">
                    <div className="flex items-center">
                      <span className="flex-shrink-0 w-32 font-semibold text-gray-700 lg:w-36">
                        Age
                      </span>
                      <span className="flex-shrink-0 mr-4 text-gray-600">
                        :
                      </span>
