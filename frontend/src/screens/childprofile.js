    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-4 pt-20">
        ...
        <div className="p-6 bg-white rounded-lg shadow-sm">
          <h1 className="mb-6 text-2xl font-bold text-red-800">
            K A W Sithuki Amandi
          </h1>
            ...
            <div className="flex-1 space-y-3">
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                <div className="flex justify-between sm:block">
                  ...
                  <span className="font-medium text-gray-900 sm:block">
                    Sithuki Amandi
                  </span>
                </div>
                <div className="flex justify-between sm:block">
        ...
        <div className="p-6 bg-white rounded-lg shadow-sm">
          <h2 className="mb-6 text-xl font-bold text-red-800">
            Recent Vaccinations
          </h2>
          ...
          <div className="space-y-4">
            ...
            <div className="relative p-4 overflow-hidden bg-white border border-gray-200 rounded-lg">
              <div className="absolute w-16 h-16 right-4 top-4 opacity-20">
                <div className="flex items-center justify-center w-full rounded-full h-ful"></div>
              </div>
            ...
            <div className="relative p-4 overflow-hidden bg-white border border-gray-200 rounded-lg">
              <div className="absolute w-16 h-16 right-4 top-4 opacity-20">
                <div className="flex items-center justify-center w-full h-full rounded-full"></div>
              </div>
